...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0), 0x00000001, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(READABLE) }, /* UpdatePossible */  \
...
\
  ...
  { ZAP_LONG_DEFAULTS_INDEX(44), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* Description */  \
  ...
  { ZAP_LONG_DEFAULTS_INDEX(52), 0x00000013, 61, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* BatReplacementDescription */  \
...
#define FIXED_DEVICE_TYPES {{0x00000012,1},{0x00000016,4},{0x00000302,2},{0x00000307,1},{0x00000011,1}}

// Array of device type offsets
#define FIXED_DEVICE_TYPE_OFFSETS { 0,2}

// Array of device type lengths
#define FIXED_DEVICE_TYPE_LENGTHS { 2,3}
